...
Some researchers also adopt both approaches (_mixed-methods_) or apply
_quantitative methods_ to _qualitative style_ data.

**Quantitative methods** are probably easier to group together, because many
approaches can be grouped under **qualitative methods**.
...
you're interested in^[_Operationalisation_ will be an important part of your lab
report]
...
- Involves testing **predictions** that logically follow from **theories** (the
_deductive_ step)^[Refer back to **Lecture 2** if you're unsure what _deductive_ means]
...
- Qualitative approaches—e.g., **grounded theory** and **phenomenology**—also
  ...
  _inductive_ step)^[Refer back to **Lecture 2** if you're unsure what _inductive_ means]

---

## Qualitative methods

Qualitative methods are extremely varied with different methodologies,
...
I'll try to draw out some contrasts between **qualitative** and
...
- Data (i.e., recordings of what the participant said) are coded and analysed to
  infer the information processing steps involved in solving the problem

The approach was used in early _Cognitive Science_ by _Simon_ and _Newell_ who
were pioneering researchers in _Cognitive Science_ and _Artificial Intelligence_
(Computational Theory of Mind)

Carries **certain assumptions** about the nature of human cognition/thinking,
e.g., that it involves _information processing in discrete sequential steps_.
...
> One famous study in cognitive ethnography involves
...
- Emphasises peoples first-hand experience and attempts to
**understand** and **describe** subjective experience from the participant's
point of view

- Used in fields like **cognitive psychology** to
understand the nature of subjective sensory experiences
...
Contrast with an **ethnographic** approach that might look at how the classroom
...
For example, if we develop a scale for **depression** then the scale must produce 
similar numbers when applied to: 

- The same person on different occasions

- Different people who are similarly depressed

And a treatment for depression, should not just **reduce scores** on our depression
...
**Qualitative** research studies phenomena _in the wild_

\

But **Quantitative** approaches instead try to exert a lot of **control** over
  phenomena.
...
which a _window isn't broken_: 

If the only difference between the two is:

- in one _a boy has thrown a rock_ 

- in the other _a boy has not thrown a rock_
...
> As I _put my foot down or lift it from the accelerator pedal_ I can observe _a
> change in the speed of the car_

So I know the **accelerator pedal** and the **speed of the car** are **causally
connected**
...
But causal claims are not always [black]{.red} and [white]{.green}. Sometimes we
...
- Sometimes two correlated variables have a causal relationship: smoking and
cancer
...
You could use an _ethnographic_ approach with, for example, bartenders: 

- You might do fieldwork in a bar **observing** bartenders.

- Through this, you might
...
- Conduct follow-up interviews or observe the training
  of bartenders for further evidence for

- Engage in bartending and critically reflect on your own
  experience 
...
#### Example simulation of flocking birds
...
In an agent-based model, the researcher simulates a group of 'agents'.
...
(their memory, goals, and rules) it's possible to see how social phenomena can
arise.
...
- If you thought that **misinformation** was more likely to spread if passed on
  ...
  then you could include this idea in your simulation.
...
## Final thoughts
 ...
 There are a lot of different methodological approaches available to you in
psychology, and this lecture has just touched on a few

You won't cover computer simulation again in undergrad, but if you stay on to do
a Masters degree (or a third year project with me) then you might get the chance
