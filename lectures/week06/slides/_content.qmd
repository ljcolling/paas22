...
The _mean_ is **sensitive to extreme values** in a way the _median_ is not
...
<!-- <source src="`r here::here('images','test.webm')" type="video/webm"> -->
<!-- </video> -->
...
- You then measure the height of people in this group, and then try to use this
