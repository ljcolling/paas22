...
df %>%
  ...
  scale_color_manual(values = c("#2aa832", "#fab900", "#ef7910",
                                "#ef7910", "#ec5692", "#d8011e", "#007ec8", "#aaaaaa"),
                     guide=F) +
  geom_hline(yintercept = rep(seq(500, 2000, by = 500), 2), size = 2, colour = "white")
```
...
df %>%
  ...
  annotate("text", x = 6.5, y = 0.23, label="IQR", size = 6, colour="black") +
  annotate("line", x = c(5.8, 7.1), y = c(0.15, 0.15), colour = "black") +
  annotate("line", x = c(5.8, 5.8), y = c(0.12, 0.15), colour = "black") +
  annotate("line", x = c(7.1, 7.1), y = c(0.12, 0.15), colour = "black") +
  annotate("line", x = c(6.4, 6.4), y = c(-0.1, 0.1), colour = "#007ec8", size = 1.5) +
  coord_cartesian(ylim = c(-0.3, 0.3)) +
  scale_x_continuous(breaks = 0:11) +
  theme(axis.ticks.y = element_blank(),
