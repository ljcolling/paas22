...
2. How is knowledge then derived from these facts
...
A simple story of how the senses work might go like this: There are some
...
2. Or "fact" could refer to **statements** about those external states
...
To understand what it might mean to **logically** derive scientific knowledge
we need to know a bit about **logic**.
...
what is false. The conclusion is just a _re-statement of the information
contained in the premises_

So **deductive logic** can't create new knowledge. What we you do instead?
...
- **More** observations are better than **fewer** observations—_but how many is
  enough?_
...
The philosopher _Karl Popper_ saw trouble with relying on **induction**. He
wanted to put science on a firmer logical footing.

He proposed that while you can't use **deduction** to figure
out what is **true**, you can use **deduction** to figure out what is **false**

He said a key quality of **scientific theories** is that they should
be **falsifiable**
...
That is, we can show that the claim "_all swans are white_" is **false**
...
Experiments don't test **one theory in isolation**, but rely on a
...
assumptions about the truth of theories related to:

- The physics of how brain imaging machines work

- Theories about how brains work by, for example, requiring oxygen during neural
  processing
...
assumptions and not **your theory**

Telling which part of the **interconnected web** of theories is at fault can be
tricky. Philosophers call this the _Duhem-Quine problem_.
...
_tweaks_ and **modify** their theories instead of abandoning them
...
nourishes; 3) Analyse fungus for poisons, etc
...
2. It can be difficult to compare two theories to see which is "better"
   - For example, if you have **Theory A** and **Theory B** and neither has been
     ...
     observations_? But then won't **trivial theories** always win?
...
- In Cognitive Science the **hard core** might include the theory that the
...
On _Lakatos's_ view, scientists work **within a research programme**.
...
- Progressive research programmes are coherent (i.e., have minimal
  ...
  - And progressive research programmes make **novel** predictions that **follow
    naturally** from theories that are part of the programme
...
In thinking about the nature of science, the status of science, and the processes
we use to create and justify knowledge, there are **a lot** of things to talk
about.

This **one course** doesn't have time to do them all justice.

In particular, I would've liked to talk about Feminist perspectives on science, 
the status of indigenous epistemologies (theories of knowledge), and how race,
racism, and colonialism impact science.
