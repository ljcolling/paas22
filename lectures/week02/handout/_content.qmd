...
unfortunately there simply isn't the time. To take just two, I would've liked to
...
if you're interested) and the status of indigenous and non-western epistemology.
For example, I grew up in Aotearoa New Zealand where Mātauranga Māori is
currently having a renaissance [see @ref2;@ref1 if you're interested].
...
require(niceQuiz)
 quiz(
   ...
   question(
   "You can use Deductive Logic to help you figure out what is true and what is
   false",
