...
unfortunately there simply isn't the time. To take just a few: I would've liked to
have been able to cover feminist perspectives on science
(see [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/entries/feminist-science/)
if you're interested). I would also have liked to cover the status of indigenous and non-western epistemology.
For example, I grew up in Aotearoa New Zealand where Mātauranga Māori is
currently having a renaissance [see @ref2;@ref1 if you're interested]. And I
would have also have liked to cover work on Race, Racism, and Colonialism---for
example, see the work of @ref3 if you're interested.
