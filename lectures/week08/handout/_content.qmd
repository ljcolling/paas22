...
We've now had the chance to see a few different sampling distributions. And we've seen
that sampling distributions of the mean look like normal distributions that have a 
mean that is equal to the population mean and that they also have a standard deviation
(the **standard error of the mean**). But how do we work out the **standard error of
the mean**?
